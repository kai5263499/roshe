...
(function(exports) {
    ...
    function match(sel, obj, asKeys) {
        var a = [];
        forEach(sel, obj, function(x) {
            a.push(x);
        }, undefined, undefined, undefined, asKeys);
        return a;
    }
    ...
    exports.match = function (sel, obj, asKeys) {
        return compile(sel).match(obj, asKeys);
    };
    exports.forEach = function(sel, obj, fun, asKeys) {
        return compile(sel).forEach(obj, fun, undefined, undefined, undefined, asKeys);
    };
